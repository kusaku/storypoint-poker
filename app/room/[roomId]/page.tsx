                ...
                <div key={user.id} className="relative flex items-start">
                  ...
                  {user.comment && (
                    <div className="absolute left-full top-0 ml-2 z-10" style={{ maxWidth: 'calc(100vw - 100% - 2rem)' }}>
                      <div className="bg-gray-800 dark:bg-gray-200 text-white dark:text-gray-900 rounded-lg px-3 py-2 text-sm shadow-lg relative" style={{ width: 'max-content', maxWidth: 'calc(100vw - 100% - 2rem)' }}>
                        <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{user.comment}</div>
